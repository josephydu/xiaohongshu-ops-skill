...
> ⚠️ 合规前置：AI 生成或辅助创作的内容发布前必须勾选「AI 辅助创作」，详见 references/xhs-compliance-2026.md。
...
4. 填写正文
5. 追加话题/标签（放正文末尾）
6. 勾选「AI 辅助创作」标签（涉及 AI 生成封面/正文时必须，详见 references/xhs-compliance-2026.md）
...
7. 勾选「AI 辅助创作」标签（文字配图由平台/AI 生成时必须；详见 references/xhs-compliance-2026.md）
8. 校验三要素后停在发布按钮（待用户确认）
